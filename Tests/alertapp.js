...
fixture `msapce soltura alert app`
...
test("login and create alert app", async (t) => {
    ...
    .click('#home-create')
    .click('#alertIcon')
    .typeText('#create-app-name', 'autoappa4')
    ...
    .typeText('#appCreationArea > div > div > div.span8 > div:nth-child(2) > div > div > div.span8 > span:nth-child(2) > div:nth-child(3) > div.row-fluid.pad-top10 > div:nth-child(1) > div > input', 'keywa4')
...
test("login and create alert app, subscription charging- change prepaid and postpaid frequency and amount", async (t) => {
...
test("login and create alert app, permsg charging", async (t) => {
    const cs = Selector('b').withText('Charging Settings');

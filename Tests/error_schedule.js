...
fixture `msapce soltura error message in schedule app`
    ...
    .beforeEach(async t => {
        await t
            ...
            .click('#home-create')
            .click(elements.scheduleMsg);
        
    });


    test("1. Error message for login and create schedule app with invalid app name ", async (t) => {
...
test("2. Error message for login and create schedule app without app description", async (t) => {    
    await t
    .typeText('#create-app-name', 'withotdes1')
    .typeText('#create-app-description', 'q')
    .click('#selectShortCodeSpan > select')
    .click(Selector('option').withText('77000'))
    .typeText('#appCreationArea > div > div > div.span8 > div:nth-child(2) > div > div > div.span8 > span:nth-child(2) > div:nth-child(3) > div.row-fluid.pad-top10 > div:nth-child(1) > div > input', 'keywa2')
    .click('#schedule-frequency-select')
...
test("3. Error message for login and create schedule app without short code", async (t) => {
    await t
...
test("4. Error message for login and create schedule app without keyword", async (t) => {
    await t
...
test("5. Error message for login and create schedule app with existing keyword", async (t) => {
...
test("6. Error message for login and create schedule app without start date", async (t) => {
...
test("7. Error message for login and create schedule app without end date", async (t) => {
...
test("8. Error message for login and create schedule app without subscription response", async (t) => {
...
test("9. Error message for login and create schedule app without unsubscription response", async (t) => {
    const rs = Selector('.ng-binding').withText('Response Settings');
...
test("10. Error message for login and create schedule app without mobile number", async (t) => {
    const gs = Selector('b').withText('General Settings')
    ...
    await t
    .typeText('#create-app-name', 'without mob num')
    .typeText('#create-app-description', 'error-for-emty-subscription response')
    .click('#selectShortCodeSpan > select')
    .click(Selector('option').withText('77000'))
...
test("11. Error message for login and create schedule app without frequecy", async (t) => {
    const ss = Selector('div').withText('Schedule Settings');
    const Errorsched = Selector('[ng-show="scheduleFrequencyValidation.show"]').child(0);
    ...
    .typeText('#appCreationArea > div > div > div.span8 > div:nth-child(2) > div > div > div.span8 > span:nth-child(2) > div:nth-child(3) > div.row-fluid.pad-top10 > div:nth-child(1) > div > input', 'keyws2')
    .click('#create-submit-btn')
    .expect(Errorsched.innerText).eql('Schedule Frequency Must be Selected');

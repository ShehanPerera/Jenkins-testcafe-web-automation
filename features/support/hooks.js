...
/**
 * TestCafe needs default structure and since we are using cucumber-js, we need to create it on the fly programmatically.
 * After all the tests have run, the test.js will be deleted.
 */
 ...
 * @param {Object} tcOptions options that can be passed to TestCafe. For more details see
...
/**
 * Exposes url which can be used as entry point for any machine that has access to the machine \
 * where tests are running (even mobile device!).
 *
 * @param {Object} tcOptions options that can be passed to TestCafe. For more details see \
 * http://devexpress.github.io/testcafe/documentation/using-testcafe/programming-interface/runner.html#run
 */
        ...
        .then(remoteConnection => {
            ...
            remoteConnection.once('ready', () => {
                runner
                    ...
                    .run({"skipJsErrors": true, "skip-uncaught-errors": true})
                    .then(failedCount => {
